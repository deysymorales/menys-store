...
<body class="hold-transition login-page" style="background-image: url('vistas/assets/imagenes/logo.jpeg'); object-fit: cover; object-position: center;">
    ...
    <div class="login-box">
        ...
        <div class="card card-outline card-primary">
            ...
            <div class="card-header text-center">
                ...
                <h1 class="h1"><b>MeNy's Store</b></h1>
