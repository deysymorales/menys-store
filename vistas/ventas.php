                    ...
                    <div class="card-body p-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7 mb-3 rounded-3" style="background-color: gray;color: white;text-align:center;border:1px solid gray;">
                                <h2 class="fw-bold m-0">Q. <span class="fw-bold" id="totalVenta">0.00</span></h2>
                            </div>
                ...
                <div class="card card-gray shadow">
                    ...
                    <div class="card-body p-2">
                        ...
                        <div class="row fw-bold">
                            ...
                            <div class="col-md-5 text-right">
                                Q. <span class="" id="boleta_igv">0.00</span>
                            </div>
        ...
        $('#lstProductosVenta tbody').on('click', '.btnIngresarPeso', function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    NuevoPrecio = ((parseFloat(data['cantidad']) * data['precio_venta_producto'].replace("Q. ", "")).toFixed(2));
                    NuevoPrecio = "Q. " + NuevoPrecio;
                    ...
                    $.ajax({
                        ...
                        success: function(respuesta) {
                            ...
                            if (parseInt(respuesta['existe']) == 0) {
                                ...
                                NuevoPrecio = (parseFloat(1) * data['precio_venta_producto'].replaceAll("Q. ", "")).toFixed(2);
                                NuevoPrecio = "Q. " + NuevoPrecio;
                                ...
                                // ACTUALIZAR EL NUEVO PRECIO DEL ITEM DEL LISTADO DE VENTA
                                NuevoPrecio = (parseFloat(cantidad_actual) * data['precio_venta_producto'].replaceAll("Q. ", "")).toFixed(2);
                                NuevoPrecio = "Q. " + NuevoPrecio;
                                table.cell(index, 7).data(NuevoPrecio).draw();
                ...
                $.ajax({
                    ...
                    success: function(respuesta) {
                        ...
                        if (parseInt(respuesta['existe']) == 0) {
                            ...
                            // ACTUALIZAR EL NUEVO PRECIO DEL ITEM DEL LISTADO DE VENTA
                            NuevoPrecio = (parseFloat(cantidad_a_comprar) * data['precio_venta_producto'].replaceAll("Q. ", "")).toFixed(2);
            ...
            if ($("#iptEfectivoRecibido").val() > 0 && $("#iptEfectivoRecibido").val() != "") {
                ...
                $.ajax({
                    ...
                    success: function(respuesta) {
                        ...
                        window.open('http://localhost/menys-store/vistas/generar_ticket.php?nro_boleta='+nro_boleta);
